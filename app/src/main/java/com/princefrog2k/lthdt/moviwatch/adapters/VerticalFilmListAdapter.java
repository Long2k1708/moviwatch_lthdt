...
public class VerticalFilmListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ...
    public VerticalFilmListAdapter(Context context, List<FilmItem> filmItems) {
        this.context = context;
        this.filmItems = filmItems;
    }

    public class VerticalFilmListViewHolder extends RecyclerView.ViewHolder {

        TextView tvFilmTitle, tvViewCount, tvTimeLength;
        ImageView imvFilmBanner;

        public VerticalFilmListViewHolder(View itemView) {
            super(itemView);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View rcvItemView = LayoutInflater.from(context).inflate(R.layout.rcv_film_item_vertical, parent, false);
        return new VerticalFilmListViewHolder(rcvItemView);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        VerticalFilmListViewHolder itemViewHolder = (VerticalFilmListViewHolder) holder;
